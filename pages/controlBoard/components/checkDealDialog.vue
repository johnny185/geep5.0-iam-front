<template>
  <el-dialog :visible.sync="dialogVisible" width="60%" :before-close="handleClose" :modal-append-to-body="false">
    ...
    <div style="text-align: center; margin: 10px 0">
      <el-button v-if="isShowAgreement" size="small" type="primary" class="btn fontSize18" @click="agreement">
        同意
      </el-button>
      <el-button v-if="!isShowAgreement" size="small" type="plain" class="btn fontSize18">
        {{ countdown }}s后同意
      </el-button>
    </div>
  </el-dialog>
